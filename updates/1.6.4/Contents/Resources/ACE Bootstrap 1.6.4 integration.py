...
# Integrate extensions with the private core state only after cumulative patches.
fix_spec = importlib.util.spec_from_file_location('ace_integration_164', str(H / 'ACE Integration 1.6.4.py'))
fix = importlib.util.module_from_spec(fix_spec)
fix_spec.loader.exec_module(fix)
fix.repair_resources(H)
